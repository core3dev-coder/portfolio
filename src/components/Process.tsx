  ...
  return (
    <section className="py-28 md:py-32 relative bg-secondary/60">
      <div className="container mx-auto px-6">
        <AnimatedSection animation="fade-up" className="text-center mb-16 space-y-4">
            ...
            >
              <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start group">
                ...
                <div className="flex-shrink-0">
                  <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-primary to-accent flex items-center justify-center text-2xl md:text-3xl font-semibold text-white group-hover:scale-110 transition-transform duration-300 hover-glow">
                    {step.number}
                  </div>
                </div>

                {/* Content */}
                <div className="flex-1 bg-card/80 border border-border rounded-3xl p-6 md:p-8 shadow-sm group-hover:border-primary/50 hover-lift transition-all duration-300">
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="w-5 h-5 text-primary group-hover:scale-110 transition-transform duration-300" />
                      <h3 className="text-2xl font-semibold group-hover:text-primary transition-colors duration-300">{step.title}</h3>
                    </div>
